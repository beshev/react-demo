            ...
            <div className="modal">
                <div className="user-container">
                    <header className="headers">
                        ...
                        <button className="btn close" onClick={onFormCloseClick}>
                    ...
                    <form onSubmit={(e) => onFormSubmit(e, user?._id)}>
                        ...
                        <div id="form-actions">
                            ...
                            <button id="action-cancel" className="btn" type="button" onClick={onFormCloseClick}>
                                Cancel
                            </button>
                        </div>
                    </form>
